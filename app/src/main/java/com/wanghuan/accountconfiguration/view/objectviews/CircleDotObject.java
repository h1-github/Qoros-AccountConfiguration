 ...
 */
public class CircleDotObject extends ObjectPointBase{

    public CircleDotObject(Context context) {
        super(context);
    }
    ...
    public void drawEnter(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                center = calculate(circleDot_point1, circleDot_point2, value);
                view.postInvalidate();
    ...
    public void drawMove(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(circleDot_point2, circleDot_point3, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
    ...
    public void drawExit(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(circleDot_point3, circleDot_point4, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
