 ...
 */
public class CompleteObject extends ObjectPointBase{

    public CompleteObject(Context context) {
        super(context);
    }
    ...
    public void drawEnter(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                center = calculate(complete_point1, complete_point2, value);
                view.postInvalidate();
    ...
    public void drawMove(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(complete_point2, complete_point4, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
    ...
    public void drawExit(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(complete_point3, complete_point4, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
