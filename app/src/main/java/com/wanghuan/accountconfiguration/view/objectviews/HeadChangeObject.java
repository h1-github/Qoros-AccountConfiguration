 ...
 */
public class HeadChangeObject extends ObjectPointBase{

    public HeadChangeObject(Context context) {
        super(context);
    }
    ...
    public void drawEnter(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                center = calculate(headChange_point1, headChange_point2, value);
                view.postInvalidate();
    ...
    public void drawMove(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(headChange_point2, headChange_point3, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
