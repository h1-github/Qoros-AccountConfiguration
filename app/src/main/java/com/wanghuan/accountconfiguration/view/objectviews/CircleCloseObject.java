 ...
 */
public class CircleCloseObject extends ObjectPointBase{

    public CircleCloseObject(Context context) {
        super(context);
    }
    ...
    public void drawEnter(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                center = calculate(circleClose_point1, circleClose_point2, value);
                view.postInvalidate();
    ...
    public void drawMove(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(circleClose_point2, circleClose_point3, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
    ...
    public void drawExit(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(circleClose_point3, circleClose_point4, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
