 ...
 */
public class CircleOpenObject extends ObjectPointBase{

    public CircleOpenObject(Context context) {
        super(context);
    }
    ...
    public void drawEnter(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                center = calculate(circleOpen_point1, circleOpen_point2, value);
                view.postInvalidate();
    ...
    public void drawMove(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(circleOpen_point2, circleOpen_point3, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
    ...
    public void drawExit(final View view) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedValue();
                center = calculate(circleOpen_point3, circleOpen_point4, value);
                view.postInvalidate();
                ACStatus.animating = value != 1;
            }
        });
